...
header.bar nav a:hover{background:var(--bg3);color:#fff;border-bottom:none}
...
footer.bar{border-top:1px solid var(--line);color:var(--dim2);font-size:11px;padding:8px 0;margin-top:30px}
footer.bar .w{display:flex;justify-content:space-between;align-items:center}
main{padding-top:20px}
h1{font-size:15px;margin:0 0 2px;color:#fff;font-weight:600;letter-spacing:.3px}
...
.box .hd{background:var(--bg3);padding:6px 12px;border-bottom:1px solid var(--line);color:#bbb;font-size:12px;display:flex;justify-content:space-between;align-items:center}
.box .bd{padding:14px}
...
/* terminal box */
.term{background:#000;border:1px solid var(--line);border-radius:0;padding:9px 12px;font-size:12px}
.term .ln{color:var(--dim)}
.term .ln .p{color:var(--dim2)}
.term .cmd{color:var(--txt)}
.term .cmd code{color:#bbb}
...
.term .cp:hover{color:#fff;border-color:#888}
/* badges */
...
.tag.ok{color:#bbb;border-color:#666}
.tag.warn{color:#999;border-color:#555}
.tag.err{color:#aaa;border-color:#777}
.tag.priv{color:#999;border-color:#555}
.tag.pub{color:#bbb;border-color:#666}
/* buttons */
.btn{display:inline-block;padding:6px 12px;border:1px solid #666;background:transparent;color:#ccc;font-family:var(--mono);font-size:12px;cursor:pointer;text-decoration:none;border-radius:0;border-bottom:1px solid #666}
.btn:hover{background:#e8e8e8;color:#000;text-decoration:none;border-bottom:1px solid #e8e8e8}
.btn.amb{border-color:#555;color:#bbb}
.btn.amb:hover{background:#ddd;color:#000;border-color:#ddd}
.btn.subtle{border-color:var(--line);color:var(--dim)}
.btn.subtle:hover{border-color:#888;color:#fff;background:transparent}
.btn.danger{border-color:#666;color:#bbb}
.btn.danger:hover{background:#bbb;color:#000;border-color:#bbb}
...
form.f input:focus,form.f select:focus,form.f textarea:focus{outline:none;border-color:#888}
form.f .row2{display:grid;grid-template-columns:1fr 1fr;gap:12px}
form.f .hint{color:var(--dim2);font-size:11px;margin-top:2px}
.notice{border:1px solid #555;background:#141414;color:#bbb;padding:10px 14px;margin-bottom:14px;font-size:12px}
.notice:before{content:"[!] ";color:var(--dim)}
.error{border:1px solid #666;background:#1a1a1a;color:#ccc;padding:10px 14px;margin-bottom:14px;font-size:12px}
.error:before{content:"[ERR] "}
.okmsg{border:1px solid #666;background:#161616;color:#ccc;padding:10px 14px;margin-bottom:14px;font-size:12px}
...
.crumb a{color:#c8c8c8}
/* blob view */
pre.blob{background:#000;border:1px solid var(--line);padding:14px;overflow-x:auto;font-size:12px;line-height:1.55;color:#ccc;margin:0}
...
.bar-meta .sha{color:#999}
.bar-meta .who{color:#aaa}
...
.navtabs a.active{color:#fff;border-bottom-color:#fff}
select.branchsel{background:#000;border:1px solid var(--line2);color:#ccc;font-family:var(--mono);font-size:12px;padding:4px 8px;border-radius:0}
.muted{color:var(--dim)}
.langtoggle{color:var(--dim);padding:0 10px;font-size:12px;border-left:1px solid var(--line2);height:100%;display:flex;align-items:center;font-weight:700}
.langtoggle:hover{color:#fff;text-decoration:none;border-bottom:none}
